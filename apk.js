...
function onTyping() {
    ...
    window.addEventListener("keydown", (clicked)=>{
        ...
        if (clicked.key.toUpperCase()==word[numberTypingTrue]) {
...
function stop(result) {
    ...
    if (result==true) {
        document.getElementById("mention").innerHTML='Felicitation !';    
    }else{
        document.getElementById("mention").innerHTML='GameOver !';
    }

    document.getElementById("menu").style.display="none";
    document.getElementById("Result").classList.remove("classRestart")
    document.getElementById('carPNG1').style.display='none';
    document.getElementById('carPNG2').style.display='none';
    document.getElementById('carPNG3').style.display='none';
    document.getElementById('carPNG4').style.display='none';
    document.getElementById("car").style.display='none';
    document.querySelector("#section1").style.display='none';
    document.querySelector(".content-word").innerHTML='';

    for(let index=1; index<=4; index++){
        document.querySelector(`#line1 div:nth-child(${index})`).style.display='none';
        document.querySelector(` #line2 div:nth-child(${index})`).style.display='none';
    }
